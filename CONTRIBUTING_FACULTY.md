...
This file is a **pointer**. The faculty handbook is the private repo
...
You must be on the **`faculty`** team to open that repository.
...
Reusable release workflow for course repos remains in this repository:
